...
const basePath = '/cnno-1775544137330';
...
export default function Home() {
  ...
  const products = [{ n: 'OG Rolls', d: 'Our signature OG Rolls are carefully handcrafted with the finest ingredients, blending traditional techniques with a modern twist to create a truly unforgettable taste experience. Each roll is baked to perfection, with a delicate balance of sweet and savory flavors.', i: 'https://images.pexels.com/photos/17430536/pexels-photo-17430536.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Pistachio Rolls', d: 'For those seeking a unique flavor combination, our Pistachio Rolls offer a delightful twist on the classic cinnamon roll, with the added crunch and nutty flavor of pistachios. Perfect for adventurous palates, these rolls are sure to surprise and delight.', i: 'https://images.pexels.com/photos/36835363/pexels-photo-36835363.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'Chocolate Rolls', d: 'Indulge in the richness of our Chocolate Rolls, where decadent chocolate and sweet cinnamon come together in perfect harmony. These rolls are a chocolate lover\'s dream, with a velvety smooth texture and deep, satisfying flavor.', i: 'https://images.pexels.com/photos/10338465/pexels-photo-10338465.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Baby Rolls', d: 'Our bite-sized Baby Rolls are the perfect snack for any time of day, with a soft and fluffy texture and a hint of sweetness. These adorable rolls are ideal for sharing with friends and family, or savoring on your own as a special treat.', i: 'https://images.pexels.com/photos/17584799/pexels-photo-17584799.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Party Box', d: 'Make any celebration even sweeter with our Party Box, a delightful assortment of our signature rolls and pastries, carefully curated to satisfy any crowd. Perfect for parties, gatherings, or special events, our Party Box is the ultimate way to share the joy of CNNO with others.', i: 'https://images.pexels.com/photos/7103709/pexels-photo-7103709.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
    ...
    <div className="min-h-screen bg-surface text-on-surface font-body selection:bg-accent/30 selection:text-primary">
      ...
      <section id="home" className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src="https://images.pexels.com/photos/30666844/pexels-photo-30666844.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940" alt="Hero" className="w-full h-full object-cover" />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft artisanal cinnamon rolls that bring comfort, warmth, and joy to our customers, while consistently delivering exceptional quality and service.</p>
                </div>
                <div className="space-y-2">
            ...
            <div className="lg:col-span-7 grid grid-cols-12 grid-rows-6 gap-4 h-[600px]">
              <div className="col-span-8 row-span-4 overflow-hidden rounded-xl">
                <img src="https://images.pexels.com/photos/16239807/pexels-photo-16239807.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 1" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-4 row-span-3 overflow-hidden rounded-xl bg-surface-container">
                <img src="https://images.pexels.com/photos/7966480/pexels-photo-7966480.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 2" className="w-full h-full object-cover" />
              </div>
              <div className="col-span-5 row-span-2 overflow-hidden rounded-xl mt-4">
                <img src="https://images.pexels.com/photos/14800853/pexels-photo-14800853.jpeg?auto=compress&cs=tinysrgb&h=650&w=940" alt="About 3" className="w-full h-full object-cover" />
              </div>
            </div>
          </div>
        </div>
